...
public class ForumServices {
    ...
    public void addForum(Context context, ForumQuestion f, String id, final ServerCallbacks serverCallbacks){
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest
                (Request.Method.POST, "http://192.168.1.3/ikotlinBackEnd/web/forums/addQuestion", jsonBody, new Response.Listener<JSONObject>() {
    ...
    public void getComments(String id, Context context, int start, int questionId, final ServerCallbacks serverCallbacks){
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest
                (Request.Method.GET, "http://192.168.1.3/ikotlinBackEnd/web/forums/getCommments?id="+id+"&questionId="+questionId+"&start="+start, jsonBody, new Response.Listener<JSONObject>() {
    ...
    public void addAnswer(Context context, String content, int idforum, String id, final ServerCallbacks serverCallbacks){
        ...
        Log.d("body",jsonBody.toString());
        JsonObjectRequest jsObjRequest = new JsonObjectRequest
                (Request.Method.POST, "http://192.168.1.3/ikotlinBackEnd/web/forums/addComment", jsonBody, new Response.Listener<JSONObject>() {
